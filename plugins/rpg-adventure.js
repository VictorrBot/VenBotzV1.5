...
let handler = async (m, { conn, usedPrefix, DevMode }) => { 
    try { 
        ...
        if (global.db.data.users[m.sender].healt > 79) {
            ...
            let str = `
Nyawa Mu Berkurang -${healt * 1} Karena Kamu Telah Berpetualang Sampai ${pickRandom(['Jepang🇯🇵', 'Korea🇰🇵', 'Bali🇮🇩', 'Amerika🇺🇲', 'Iraq🇮🇶', 'Arab🇸🇦', 'Pakistan🇵🇰', 'German🇩🇪', 'Finlandia🇫🇮', 'Ke bawa dunia mimpi💭', 'Ujung dunia⚫', 'Mars🍁', 'Bulan🌙', 'Pluto🌑', 'Matahari☀️', 'Hatinya dia♥️', '...'])} Dan Mendapatkan\n
*✨Exp:* ${exp} 
*💵Uang:* ${uang}
